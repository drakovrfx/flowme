var De = globalThis, xt = De.ShadowRoot && (De.ShadyCSS === void 0 || De.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, $t = /* @__PURE__ */ Symbol(), Ot = /* @__PURE__ */ new WeakMap(), Hi = class {
  constructor(i, e, t) {
  ...
  get styleSheet() {
    ...
    if (xt && i === void 0) {
      ...
      t && (i = Ot.get(e)), i === void 0 && ((this.o = i = new CSSStyleSheet()).replaceSync(this.cssText), t && Ot.set(e, i));
    }
    return i;
  }
  toString() {
...
}, An = (i) => new Hi(typeof i == "string" ? i : i + "", void 0, $t), _t = (i, ...e) => new Hi(i.length === 1 ? i[0] : e.reduce((t, n, o) => t + ((r) => {
  if (r._$cssResult$ === !0) return r.cssText;
  if (typeof r == "number") return r;
  throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
})(n) + i[o + 1], i[0]), i, $t), Sn = (i, e) => {
...
}, Lt = xt ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const n of e.cssRules) t += n.cssText;
  return An(t);
})(i) : i, Ht, { is: Cn, defineProperty: Fn, getOwnPropertyDescriptor: Mn, getOwnPropertyNames: Pn, getOwnPropertySymbols: Nn, getPrototypeOf: Rn } = Object, ue = globalThis, Ut = ue.trustedTypes, En = Ut ? Ut.emptyScript : "", Tn = ue.reactiveElementPolyfillSupport, $e = (i, e) => i, Ue = {
  toAttribute(i, e) {
    switch (e) {
      case Boolean:
        i = i ? En : null;
...
(Ht = Symbol).metadata ?? (Ht.metadata = /* @__PURE__ */ Symbol("metadata")), ue.litPropertyMetadata ?? (ue.litPropertyMetadata = /* @__PURE__ */ new WeakMap());
var pe = class extends HTMLElement {
  ...
  static createProperty(i, e = Wt) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(i) && ((e = Object.create(e)).wrapped = !0), this.elementProperties.set(i, e), !e.noAccessor) {
      ...
      n !== void 0 && Fn(this.prototype, i, n);
    }
  }
  static getPropertyDescriptor(i, e, t) {
    const { get: n, set: o } = Mn(this.prototype, i) ?? {
      get() {
        return this[e];
      },
      set(r) {
  ...
  static getPropertyOptions(i) {
    return this.elementProperties.get(i) ?? Wt;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty($e("properties"))) {
      const e = this.properties, t = [...Pn(e), ...Nn(e)];
  ...
  static finalizeStyles(i) {
    ...
    if (Array.isArray(i)) {
      ...
      for (const n of t) e.unshift(Lt(n));
    } else i !== void 0 && e.push(Lt(i));
    return e;
  }
  static _$Eu(i, e) {
    const t = e.attribute;
  ...
  createRenderRoot() {
    ...
    return Sn(i, this.constructor.elementStyles), i;
  }
  connectedCallback() {
  ...
  _$ET(i, e) {
    ...
    if (n !== void 0 && t.reflect === !0) {
      const o = (t.converter?.toAttribute !== void 0 ? t.converter : Ue).toAttribute(e, t.type);
  ...
  _$AK(i, e) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const o = t.getPropertyOptions(n), r = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : Ue;
      this._$Em = n;
...
pe.elementStyles = [], pe.shadowRootOptions = { mode: "open" }, pe[$e("elementProperties")] = /* @__PURE__ */ new Map(), pe[$e("finalized")] = /* @__PURE__ */ new Map(), Tn?.({ ReactiveElement: pe }), (ue.reactiveElementVersions ?? (ue.reactiveElementVersions = [])).push("2.1.2");
var We = globalThis, jt = (i) => i, je = We.trustedTypes, Vt = je ? je.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, At = "$lit$", q = `lit$${Math.random().toFixed(9).slice(2)}$`, St = "?" + q, In = `<${St}>`, re = document, ke = () => re.createComment(""), Ae = (i) => i === null || typeof i != "object" && typeof i != "function", Ct = Array.isArray, Ui = (i) => Ct(i) || typeof i?.[Symbol.iterator] == "function", Ze = `[ 	
\f\r]`, me = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Gt = /-->/g, qt = />/g, ee = RegExp(`>|${Ze}(?:([^\\s"'>=/]+)(${Ze}*=${Ze}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Xt = /'/g, Yt = /"/g, Wi = /^(?:script|style|textarea|title)$/i, Ft = (i) => (e, ...t) => ({
  _$litType$: i,
  strings: e,
  values: t
}), b = Ft(1), Zt = Ft(2), cs = Ft(3), he = /* @__PURE__ */ Symbol.for("lit-noChange"), _ = /* @__PURE__ */ Symbol.for("lit-nothing"), Kt = /* @__PURE__ */ new WeakMap(), ie = re.createTreeWalker(re, 129);
function ji(i, e) {
...
var Vi = (i, e) => {
  ...
  let o, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = me;
  for (let a = 0; a < t; a++) {
    const d = i[a];
    let l, p, u = -1, h = 0;
    for (; h < d.length && (s.lastIndex = h, p = s.exec(d), p !== null); ) h = s.lastIndex, s === me ? p[1] === "!--" ? s = Gt : p[1] !== void 0 ? s = qt : p[2] !== void 0 ? (Wi.test(p[2]) && (o = RegExp("</" + p[2], "g")), s = ee) : p[3] !== void 0 && (s = ee) : s === ee ? p[0] === ">" ? (s = o ?? me, u = -1) : p[1] === void 0 ? u = -2 : (u = s.lastIndex - p[2].length, l = p[1], s = p[3] === void 0 ? ee : p[3] === '"' ? Yt : Xt) : s === Yt || s === Xt ? s = ee : s === Gt || s === qt ? s = me : (s = ee, o = void 0);
    const f = s === ee && i[a + 1].startsWith("/>") ? " " : "";
    r += s === me ? d + In : u >= 0 ? (n.push(l), d.slice(0, u) + At + d.slice(u) + q + f) : d + q + (u === -2 ? a : f);
  }
  return [ji(i, r + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), n];
}, pt = class Gi {
  constructor({ strings: e, _$litType$: t }, n) {
    let o;
    this.parts = [];
    let r = 0, s = 0;
    const a = e.length - 1, d = this.parts, [l, p] = Vi(e, t);
    if (this.el = Gi.createElement(l, n), ie.currentNode = this.el.content, t === 2 || t === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (o = ie.nextNode()) !== null && d.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const u of o.getAttributeNames()) if (u.endsWith(At)) {
          const h = p[s++], f = o.getAttribute(u).split(q), y = /([.?@])?(.*)/.exec(h);
          d.push({
            type: 1,
            index: r,
            name: y[2],
            strings: f,
            ctor: y[1] === "." ? Yi : y[1] === "?" ? Zi : y[1] === "@" ? Ki : Me
          }), o.removeAttribute(u);
        } else u.startsWith(q) && (d.push({
          type: 6,
          index: r
        }), o.removeAttribute(u));
        if (Wi.test(o.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let f = 0; f < h; f++) o.append(u[f], ke()), ie.nextNode(), d.push({
              type: 2,
              index: ++r
            });
            o.append(u[h], ke());
        ...
        let u = -1;
        for (; (u = o.data.indexOf(q, u + 1)) !== -1; ) d.push({
          type: 7,
          index: r
        }), u += q.length - 1;
      }
...
function se(i, e, t = i, n) {
  ...
  return o?.constructor !== r && (o?._$AO?.(!1), r === void 0 ? o = void 0 : (o = new r(i), o._$AT(i, t, n)), n !== void 0 ? (t._$Co ?? (t._$Co = []))[n] = o : t._$Cl = o), o !== void 0 && (e = se(i, o._$AS(i, e.values), o, n)), e;
}
var qi = class {
  constructor(i, e) {
  ...
  u(i) {
    const { el: { content: e }, parts: t } = this._$AD, n = (i?.creationScope ?? re).importNode(e, !0);
    ie.currentNode = n;
    let o = ie.nextNode(), r = 0, s = 0, a = t[0];
    for (; a !== void 0; ) {
      if (r === a.index) {
        let d;
        a.type === 2 ? d = new Ye(o, o.nextSibling, this, i) : a.type === 1 ? d = new a.ctor(o, a.name, a.strings, this, i) : a.type === 6 && (d = new Ji(o, this, i)), this._$AV.push(d), a = t[++s];
      }
      r !== a?.index && (o = ie.nextNode(), r++);
    }
    return ie.currentNode = re, n;
  }
  p(i) {
    let e = 0;
  ...
  _$AI(e, t = this) {
    e = se(this, e, t), Ae(e) ? e === _ || e == null || e === "" ? (this._$AH !== _ && this._$AR(), this._$AH = _) : e !== this._$AH && e !== he && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ui(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== _ && Ae(this._$AH) ? this._$AA.nextSibling.data = e : this.T(re.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: n } = e, o = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = pt.createElement(ji(n.h, n.h[0]), this.options)), n);
    if (this._$AH?._$AD === o) this._$AH.p(t);
    else {
      const r = new qi(o, this), s = r.u(this.options);
      r.p(t), this.T(s), this._$AH = r;
    }
  }
  _$AC(e) {
    let t = Kt.get(e.strings);
    return t === void 0 && Kt.set(e.strings, t = new pt(e)), t;
  }
  k(e) {
    Ct(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let n, o = 0;
    for (const r of e) o === t.length ? t.push(n = new Xi(this.O(ke()), this.O(ke()), this, this.options)) : n = t[o], n._$AI(r), o++;
    o < t.length && (this._$AR(n && n._$AB.nextSibling, o), t.length = o);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    for (this._$AP?.(!1, !0, t); e !== this._$AB; ) {
      const n = jt(e).nextSibling;
      jt(e).remove(), e = n;
    }
  }
  setConnected(e) {
  ...
  _$AI(i, e = this, t, n) {
    ...
    let r = !1;
    if (o === void 0) i = se(this, i, e, 0), r = !Ae(i) || i !== this._$AH && i !== he, r && (this._$AH = i);
    else {
      const s = i;
      let a, d;
      for (i = o[0], a = 0; a < o.length - 1; a++) d = se(this, s[t + a], e, a), d === he && (d = this._$AH[a]), r || (r = !Ae(d) || d !== this._$AH[a]), d === _ ? i = _ : i !== _ && (i += (d ?? "") + o[a + 1]), this._$AH[a] = d;
    }
    r && !n && this.j(i);
  }
  j(i) {
  ...
  _$AI(i, e = this) {
    if ((i = se(this, i, e, 0) ?? _) === he) return;
  ...
  B: Yi,
  F: Ji
}, Dn = We.litHtmlPolyfillSupport;
Dn?.(pt, Ye), (We.litHtmlVersions ?? (We.litHtmlVersions = [])).push("3.3.2");
var zn = (i, e, t) => {
  const n = t?.renderBefore ?? e;
  let o = n._$litPart$;
  if (o === void 0) {
    const r = t?.renderBefore ?? null;
    n._$litPart$ = o = new Ye(e.insertBefore(ke(), r), r, void 0, t ?? {});
  }
  return o._$AI(i), o;
}, Ve = globalThis, oe = class extends pe {
  constructor() {
...
oe._$litElement$ = !0, oe.finalized = !0, Ve.litElementHydrateSupport?.({ LitElement: oe });
var On = Ve.litElementPolyfillSupport;
On?.({ LitElement: oe });
...
function Pe(i) {
  return (e, t) => typeof t == "object" ? Hn(i, e, t) : ((n, o, r) => {
...
var Wn = {
  ...
  for (const n of t) n._$AO?.(e, !1), _e(n, e);
  return !0;
}, Ge = (i) => {
  let e, t;
  do {
...
function Gn(i) {
  this._$AN !== void 0 ? (Ge(this), this._$AM = i, Qi(this)) : this._$AM = i;
}
function qn(i, e = !1, t = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0) if (e) if (Array.isArray(n)) for (let r = t; r < n.length; r++) _e(n[r], !1), Ge(n[r]);
  else n != null && (_e(n, !1), Ge(n));
  else _e(this, i);
}
var Xn = (i) => {
  i.type == Wn.CHILD && (i._$AP ?? (i._$AP = qn), i._$AQ ?? (i._$AQ = Gn));
}, Yn = class extends Vn {
  constructor() {
    super(...arguments), this._$AN = void 0;
  }
  _$AT(i, e, t) {
    super._$AT(i, e, t), Qi(this), this.isConnected = i._$AU;
  }
  _$AO(i, e = !0) {
    i !== this.isConnected && (this.isConnected = i, i ? this.reconnected?.() : this.disconnected?.()), e && (_e(this, i), Ge(this));
  }
  setValue(i) {
    if (Un(this._$Ct)) this._$Ct._$AI(i, this);
    else {
...
}, Ke = /* @__PURE__ */ new WeakMap(), G = jn(class extends Yn {
  render(i) {
    return _;
  }
  update(i, [e]) {
  ...
  rt(i) {
    if (this.isConnected || (i = void 0), typeof this.G == "function") {
      ...
      let t = Ke.get(e);
      t === void 0 && (t = /* @__PURE__ */ new WeakMap(), Ke.set(e, t)), t.get(this.G) !== void 0 && this.G.call(this.ht, void 0), t.set(this.G, i), i !== void 0 && this.G.call(this.ht, i);
    } else this.G.value = i;
  }
  get lt() {
...
function on(i, e = "card_config") {
  const t = [], n = /* @__PURE__ */ new WeakSet(), o = (r, s) => {
    if (r != null) {
      if (typeof r == "string") {
        const a = r.trim().toLowerCase();
        for (const d of Jn) if (a.startsWith(d)) {
          t.push({
            path: s,
            value: r,
            scheme: d
...
var ze = 1e-3, Nt = 2e-3;
function Rt(i, e) {
  const t = Ce(i), n = Math.min(e.minDur, e.maxDur), o = Math.max(e.minDur, e.maxDur);
...
function dn(i, e, t) {
  let n;
  if (e.zeroThresholdEnabled && e.zeroThreshold !== void 0 ? !(e.peak > 0) || !Number.isFinite(e.peak) ? n = Math.abs(i) < ze : n = Math.min(1, Math.abs(i) / e.peak) < (Number.isFinite(e.zeroThreshold) && e.zeroThreshold > 0 && e.zeroThreshold <= 1 ? e.zeroThreshold : Nt) : n = Math.abs(i) < ze, t?.flowId) {
    const o = e.peak > 0 && Number.isFinite(e.peak) ? Math.min(1, Math.abs(i) / e.peak).toFixed(6) : "(n/a)";
    A("threshold check:", t.flowId, "mode:", e.zeroThresholdEnabled ? "pct" : "epsilon", "scaledValue:", i, "peak:", e.peak, "pct:", o, "epsilon:", ze, "zeroThreshold:", e.zeroThresholdEnabled ? e.zeroThreshold : "(off)", "thresholdSource:", e.zeroThresholdSource, "stopping:", n);
  }
  return n;
}
function qe(i, e, t) {
  ...
  (!(p > 0) || !(u > p) || u > 6e4) && (p = 100, u = Qt), u = Math.min(u, 6e4), p >= u && (p = 100, u = Qt);
...
function oo(i, e, t) {
  ...
  if (e === 0) o = r = s = t;
    ...
    o = et(l, d, n + 1 / 3), r = et(l, d, n), s = et(l, d, n - 1 / 3);
  }
  const a = (d) => Math.round(d * 255).toString(16).padStart(2, "0");
  return `#${a(o)}${a(r)}${a(s)}`;
}
function un(i, e) {
  const t = e.high_value - e.low_value, n = t === 0 ? 0 : Math.max(0, Math.min(1, (i - e.low_value) / t)), [o, r, s] = ti(e.low_color), [a, d, l] = ti(e.high_color), [p, u, h] = ii(o, r, s), [f, y, m] = ii(a, d, l);
  let v = f - p;
  return v > 180 && (v -= 360), v < -180 && (v += 360), oo((p + v * n + 360) % 360, Jt(u, y, n), Jt(h, m, n));
}
var ro = [
  ".mp4",
  ".webm",
...
function W(i) {
  if (!i) return !1;
  const e = i.toLowerCase().split("?")[0] ?? "";
  return ro.some((t) => e.endsWith(t));
}
function hn() {
  try {
...
function so(i, e) {
  ...
  if (t === "generic" || !fe.includes(t)) return;
...
function lo(i, e, t, n) {
  ...
  if (o === "energy") {
    ...
    if (s = ni(e, r), !s) {
      const l = Math.abs(n ?? 0) % r.roles.length, p = r.roles[l], u = Xe(p, t);
...
function co(i) {
  return (j[i ?? "generic"] ?? j.generic).roles.map((e) => e.key);
}
function po(i, e, t, n) {
  if (i === void 0) {
...
function si(i, e) {
  ...
  const t = i;
  return ri.some((n) => t.startsWith(n)) || $(e, c("validation.urlMustStartWith", ri.join(", "), t.slice(0, 40))), t;
}
function uo(i, e, t) {
  const n = `nodes[${e}]`;
...
function fo(i, e, t, n, o) {
  ...
  const h = s.waypoints;
  let f = [];
  h !== void 0 && (Array.isArray(h) || $(`${r}.waypoints`, c("validation.waypointsMustBeArray")), f = h.map((v, g) => Tt(v, `${r}.waypoints[${g}]`)));
  const y = {
    id: d,
    from_node: l,
    to_node: p,
...
function mo(i) {
  ...
  const e = i, t = {};
  if (e.node_radius !== void 0 && (t.node_radius = K(e.node_radius, "defaults.node_radius")), e.burst_trigger_ratio !== void 0) {
    const n = K(e.burst_trigger_ratio, "defaults.burst_trigger_ratio");
    n > 1 && $("defaults.burst_trigger_ratio", c("validation.burstTriggerMax1")), t.burst_trigger_ratio = n;
  }
  return e.burst_sustain_ms !== void 0 && (t.burst_sustain_ms = K(e.burst_sustain_ms, "defaults.burst_sustain_ms")), e.burst_max_particles !== void 0 && (t.burst_max_particles = K(e.burst_max_particles, "defaults.burst_max_particles")), e.dot_radius !== void 0 && (t.dot_radius = K(e.dot_radius, "defaults.dot_radius")), e.line_width !== void 0 && (t.line_width = K(e.line_width, "defaults.line_width")), e.peak_value !== void 0 && (t.peak_value = K(e.peak_value, "defaults.peak_value")), t;
}
function It(i, e) {
...
function vo(i, e) {
  ...
  if (t.animation_style !== void 0) {
    ...
    ht.includes(g) || $(`${e}.animation_style`, c("validation.mustBeOneOf", ht.join(", "))), n.animation_style = g;
  }
  t.particle_shape !== void 0 && (ft.includes(t.particle_shape) || $(`${e}.particle_shape`, c("validation.mustBeOneOf", ft.join(", "))), n.particle_shape = t.particle_shape), t.direction !== void 0 && (gt.includes(t.direction) || $(`${e}.direction`, c("validation.mustBeOneOf", gt.join(", "))), n.direction = t.direction), t.particle_spacing !== void 0 && (mt.includes(t.particle_spacing) || $(`${e}.particle_spacing`, c("validation.mustBeOneOf", mt.join(", "))), n.particle_spacing = t.particle_spacing), t.custom_svg_path !== void 0 && (typeof t.custom_svg_path != "string" && $(`${e}.custom_svg_path`, c("validation.mustBeSvgPathString")), t.custom_svg_path.length === 0 && A(`${e}.custom_svg_path is empty — will fall back to circle`), n.custom_svg_path = t.custom_svg_path);
  const o = (g, w) => {
    const x = t[g];
    if (x !== void 0)
  ...
  if (m !== void 0 && v !== void 0 && m >= v && (A(`${e}: min_duration >= max_duration — dropping both`), delete n.min_duration, delete n.max_duration), t.zero_threshold !== void 0) {
    ...
    typeof g == "number" && Number.isFinite(g) && g > 0 && g <= 1 ? n.zero_threshold = g : A(`${e}.zero_threshold invalid — using default`, Nt);
  }
  return n;
}
function ai(i, e) {
...
function yo(i, e) {
  ...
  const n = {
    ...
    low_color: ai(t.low_color, `${e}.low_color`),
    high_color: ai(t.high_color, `${e}.high_color`)
  };
...
function xe(i) {
  if (!i || typeof i != "object") throw new Et(c("validation.configMustBeObject"));
  const e = i;
  e.type !== "custom:flowme-card" && $("type", c("validation.typeMustBeFlowme", String(e.type)));
  const t = e.domain, n = typeof t == "string" ? en(t) : "energy", o = e.background;
  o !== void 0 && (o === null || typeof o != "object") && $("background", c("validation.backgroundWhenProvided"));
  const r = o ?? {}, s = { default: r.default === void 0 || r.default === "" ? "" : si(r.default, "background.default") };
  if (r.weather_entity !== void 0 && (typeof r.weather_entity != "string" && $("background.weather_entity", c("validation.mustBeStringEntityId")), s.weather_entity = r.weather_entity), r.weather_states !== void 0) {
    ...
    for (const [m, v] of f) {
      ...
      typeof v != "string" && $(`background.weather_states.${m}`, c("validation.mustBeString")), y[m] = si(v, `background.weather_states.${m}`);
    }
    s.weather_states = y;
  }
  ...
  const d = /* @__PURE__ */ new Set(), l = a.map((f, y) => uo(f, y, d));
  ...
  if (e.aspect_ratio !== void 0 && ((typeof e.aspect_ratio != "string" || !/^\d+:\d+$/.test(e.aspect_ratio)) && $("aspect_ratio", c("validation.aspectRatioRegex")), h.aspect_ratio = e.aspect_ratio), e.pause_when_hidden !== void 0 && (typeof e.pause_when_hidden != "boolean" && $("pause_when_hidden", c("validation.mustBeBoolean")), h.pause_when_hidden = e.pause_when_hidden), e.overlays !== void 0) {
    ...
    h.overlays = e.overlays.map((y, m) => $o(y, m, f));
  }
  return e.defaults !== void 0 && (h.defaults = mo(e.defaults)), e.domain_colors !== void 0 && (h.domain_colors = xo(e.domain_colors)), e.debug !== void 0 && (typeof e.debug != "boolean" && $("debug", c("validation.mustBeBoolean")), h.debug = e.debug), e.opacity !== void 0 && (h.opacity = bo(e.opacity)), e.animation !== void 0 && (h.animation = wo(e.animation)), h;
}
function $o(i, e, t) {
  const n = `overlays[${e}]`;
  (!i || typeof i != "object") && $(n, c("validation.mustBeObject"));
...
var _o = {
  ...
  wave_amplitude_curve(i) {
    return to(2 + Math.abs(i) / 60, 2, 10);
  },
  describe(i) {
...
function O(i) {
  return i && i in li ? li[i] : fn;
}
var gn = "#CCCCCC", Fo = /^#([0-9A-Fa-f]{3}|[0-9A-Fa-f]{6})$/;
function bt(i) {
  return typeof i == "string" && Fo.test(i.trim()) ? i.trim() : "#FFFFFF";
}
function tt(i) {
  return typeof i == "string" && i.trim() !== "" ? i.trim() : void 0;
}
function ae(i, e, t, n, o, r) {
  const s = tt(i.color), a = s !== void 0 ? void 0 : po(t, i, o, r), d = s ?? a;
  let l;
  return n >= 0 ? l = tt(i.color_positive) ?? d ?? e.default_color_positive : l = tt(i.color_negative) ?? d ?? e.default_color_negative, bt(l);
}
function ci() {
  return {
...
var No = Po(), Ro = 2e3, Re = 3, pi = 5, it = 2, Eo = 0.9, To = 5e3, Ee = 20, Io = 0.2, Te = 0.3;
function Bo(i) {
...
var zo = [
  ...
  async init(i, e) {
    ...
    const n = await an(i);
    (n.width === 0 || n.height === 0) && await ln(i), ce("stable dims:", i.offsetWidth, i.offsetHeight), this.onResize(), ce("post-resize dims:", i.offsetWidth, i.offsetHeight);
  }
  applyConfig(i) {
    if (this.svg) {
  ...
  updateFlow(i, e) {
    this.flowsById.has(i) && (this.latestValues.set(i, Ce(e)), this.applyUpdate());
  }
  ...
  syncFlowPathGeometry(i, e, t) {
    ...
    if ((i.animation?.direction ?? "auto") === "both") {
      ...
      const p = t >= 0 ? a : d;
      e.path.setAttribute("d", ye(p, n, l));
    }
  ...
  buildSkeleton() {
    ...
    for (const n of this.config.flows) {
      ...
      d.setAttribute("id", a), d.setAttribute("d", ye(s, i, n.line_style ?? "corner")), d.setAttribute("fill", "none"), e.appendChild(d);
      ...
      const p = this.config?.defaults?.line_width ?? it, u = document.createElementNS(N, "use");
      ...
      this.svg.appendChild(l), this.flowNodes.set(n.id, h), ce("skeleton:", n.id, "| style=", h.style, "| line_style=", n.line_style ?? "corner (default)");
    }
  }
  onResize() {
    if (!this.svg || !this.config) return;
  ...
  applyFlow(i, e) {
    ...
    if (!t || !n) return;
    const o = Ce(e), r = t.animation ?? {}, s = this.animStyle(t);
    n.style !== s && (this._currentDuration.delete(i), this.teardownStyle(n), n.style = s);
    const a = this.profileFor(t), d = qe(t, a, this.config), l = Math.abs(o), p = dn(o, d, { flowId: i }), u = r.shimmer === !0, h = d.zeroThresholdEnabled && d.zeroThreshold !== void 0 ? d.peak * d.zeroThreshold : ze, f = u && l <= h && l > 0;
    if (t.visible === !1) {
      n.group.style.display = "none";
      return;
    }
    n.group.style.display = "";
    const y = No ? Ro : Rt(o, d), m = t.speed_multiplier ?? 1;
    let v = Math.max(50, y * m);
    f && (v = v / Io);
    let g;
    if (p)
      this._currentDuration.delete(i), di(i, this.durInterp), g = v;
    else {
      const X = cn(this._currentDuration.get(i) ?? v, v);
      this._currentDuration.set(i, X), g = X, this.durInterp.currentDurMs.set(i, g), di(i, this.durInterp);
    }
    const w = this.config?.animation?.smooth_speed !== !1, x = r.direction ?? "auto", M = this.computeIntendedTravelSign(t, o);
    let R = M, k = f ? Te : 1;
    const S = 600, T = 300;
    if (w && x === "auto") {
      const X = this.lastDirection.get(i), kn = this.dirChanging.get(i);
      X !== void 0 && X !== M && !kn && this.dirChanging.set(i, {
        startMs: performance.now(),
        oldDir: X,
        newDir: M
      });
      const Ne = this.dirChanging.get(i);
      if (Ne) {
        const Y = performance.now() - Ne.startMs;
        Y < S ? (Y < T ? (k = (f ? Te : 1) * (1 - Y / T), R = Ne.oldDir) : (k = (f ? Te : 1) * ((Y - T) / T), R = Ne.newDir), !u && Y >= 280 && Y <= 320 && (g = Math.max(g, 45e3)), u && Y >= 270 && Y <= 330 && (k = Math.max(k, Te))) : (this.dirChanging.delete(i), R = M);
      }
    }
    this.lastDirection.set(i, M);
    const I = t.domain ?? this.config?.domain, z = this.config?.flows.findIndex((X) => X.id === i) ?? -1, U = ae(t, a, I, R, this.config?.domain_colors, z >= 0 ? z : 0), le = this.gradientColors.get(i), zt = t.value_gradient?.mode ?? "flow", $n = bt(le && zt !== "line" ? le : U), _n = bt(le && zt !== "flow" ? le : U), Q = $n;
    n.outline && n.outline.setAttribute("stroke", _n), this.setGroupOpacity(n, k), this.syncFlowPathGeometry(t, n, R);
    const ge = this.updateBurstState(i, l, d, a);
    switch (ce("applyFlow:", i, "style=", s, "dur=", g, "dir=", R, "color=", Q), s) {
      case "dots":
        this.applyDots(n, t, a, o, g, Q, R, ge, p);
        break;
      case "dash":
        this.applyDash(n, t, g, Q, R, ge, p);
        break;
      case "arrow":
        this.applyArrows(n, t, g, Q, R, ge, p);
        break;
      case "trail":
        this.applyTrail(n, t, g, Q, R, ge, p);
        break;
      case "fluid":
        this.applyFluid(n, t, g, Q, p);
        break;
      case "none":
  ...
  updateBurstState(i, e, t, n) {
    const o = t.peak, r = this.config?.defaults?.burst_trigger_ratio ?? Eo, s = this.config?.defaults?.burst_sustain_ms ?? To;
    if (e < o * r)
  ...
  runAdaptivePassIfDue(i) {
    ...
    for (const r of this.config.flows) {
      ...
      const a = this.profileFor(r), d = Math.abs(this.latestValues.get(r.id) ?? 0), l = qe(r, a, this.config), p = this.updateBurstState(r.id, d, l, a), u = Math.max(1, Math.round(a.particle_count_curve ? a.particle_count_curve(d) : Re)), h = this.config.defaults?.burst_max_particles ?? Ee, f = Math.min(h, Math.max(1, Math.round(u * p)));
  ...
  resolveParticleCount(i, e, t, n) {
    ...
    const r = this.animStyle(i), s = Math.max(1, Math.round(e.particle_count_curve ? e.particle_count_curve(t) : Re)), a = Math.max(1, s), d = this.config?.defaults?.burst_max_particles ?? Ee, l = Math.min(d, Math.max(1, Math.round(a * n)));
    return r === "dots" || r === "trail" ? Math.min(this.adaptiveCount.get(i.id) ?? l, l) : l;
  }
  resolveParticleRadius(i) {
    return (this.config?.defaults?.dot_radius ?? pi) * (i.animation?.particle_size ?? 1);
  }
  resolveGlow(i, e) {
  ...
  applyDots(i, e, t, n, o, r, s, a, d = !1) {
    ...
    const f = `${(o / 1e3).toFixed(3)}s`, y = o / 1e3, m = l === "both" ? y / 2 : 0, v = e.animation ?? {}, g = this.resolveParticleBegins(e.id, p, o, v), w = (x, M, R) => {
      for (let k = 0; k < x.length; k++) {
        ...
        T.setAttribute("repeatCount", "indefinite"), T.setAttribute("dur", f), T.setAttribute("rotate", this.particleMotionRotateAttr(u)), T.setAttribute("begin", `${((g[k] ?? 0) + R).toFixed(3)}s`);
        const I = document.createElementNS(N, "mpath"), z = this.motionPathRef(i, e, M);
        I.setAttributeNS(L, "href", `#${z}`), I.setAttribute("href", `#${z}`), T.appendChild(I), S.animateMotion.replaceWith(T), S.animateMotion = T, S.shape.appendChild(T);
      }
    };
  ...
  applyDash(i, e, t, n, o, r, s = !1) {
    ...
    i.particles = [];
    const a = e.animation?.direction ?? "auto", d = this.config?.defaults?.line_width ?? it, l = (e.animation ?? {}).dash_gap ?? 0.5, p = Math.max(0.1, l / r), u = 14, h = u * p, f = u + h, y = this.glowFilter(e, this.profileFor(e), n), m = `${(t / 1e3).toFixed(3)}s`, v = (g) => {
  ...
  applyArrows(i, e, t, n, o, r, s = !1) {
    const a = this.profileFor(e), d = e.animation?.particle_count ?? Re, l = this.config?.defaults?.burst_max_particles ?? Ee, p = s ? 0 : Math.min(l, Math.max(1, Math.round(d * r))), u = e.animation?.flicker === !0, h = e.animation?.direction ?? "auto";
    ...
    const f = `${(t / 1e3).toFixed(3)}s`, y = t / 1e3, m = h === "both" ? y / 2 : 0, v = this.resolveParticleBegins(e.id, p, t, e.animation ?? {}), g = (w, x, M) => {
      for (let R = 0; R < w.length; R++) {
        ...
        const T = document.createElementNS(N, "mpath"), I = this.motionPathRef(i, e, x);
  ...
  applyTrail(i, e, t, n, o, r, s = !1) {
    const a = this.profileFor(e), d = e.animation?.particle_count ?? Re, l = this.config?.defaults?.burst_max_particles ?? Ee, p = s ? 0 : Math.min(l, Math.max(1, Math.round(d * r)));
    if (s) {
    ...
    const M = (k, S, T) => {
      ...
      I.setAttribute("repeatCount", "indefinite"), I.setAttribute("dur", m), I.setAttribute("rotate", f), I.setAttribute("begin", `${S.toFixed(4)}s`);
      const z = document.createElementNS(N, "mpath"), U = this.motionPathRef(i, e, T);
      return z.setAttributeNS(L, "href", `#${U}`), z.setAttribute("href", `#${U}`), I.appendChild(z), k.replaceWith(I), I;
    }, R = (k, S, T) => {
      this.updateParticleColor(k, n, e, a, u);
  ...
  paintFluidStrokeWithGradient(i, e, t, n, o, r, s, a, d, l, p) {
    ...
    let v, g;
    try {
      const S = n.getPointAtLength(0), T = n.getPointAtLength(m);
      v = {
        x: S.x,
        y: S.y
      }, g = {
      ...
      v = Se(f.position, S), g = Se(y.position, S);
    }
  ...
  applyFluid(i, e, t, n, o = !1) {
    ...
    if (!a || !d) return;
    const l = e.animation?.direction ?? "auto", p = e.id.replace(/[^a-zA-Z0-9_-]/g, "_"), u = (this.config?.defaults?.line_width ?? it) * 3, h = this.glowFilter(e, this.profileFor(e), n);
    if (l === "both") {
      this.ensurePathRev(i);
  ...
  makeTrailParticle(i, e, t, n, o) {
    ...
    for (let v = 0; v < 4; v++) {
      const g = document.createElementNS(N, "g"), { shape: w } = this.buildParticleShapeOnly(i, a, r * Oo[v], n, e);
      s && w.setAttribute("filter", this.glowFilter(e, t, n)), w.setAttribute("opacity", String(Lo[v])), g.appendChild(w);
  ...
  buildParticleShapeOnly(i, e, t, n, o, r) {
    ...
    switch (e) {
      ...
      case "arrow": {
        const d = (this.config?.defaults?.dot_radius ?? pi) * (o.animation?.particle_size ?? 1) / 10, l = document.createElementNS(N, "path");
        l.setAttribute("d", Bo(d)), l.setAttribute("fill", n), l.setAttribute("opacity", "0"), l.setAttribute("data-kind", "arrow"), s = l;
        break;
      }
      case "teardrop": {
        const d = document.createElementNS(N, "path");
        d.setAttribute("d", Do(t)), d.setAttribute("fill", n), d.setAttribute("opacity", "0"), d.setAttribute("data-kind", "teardrop"), s = d;
        break;
      }
      case "diamond": {
  ...
  primaryColor(i) {
    ...
    return ae(i, e, t, 1, this.config?.domain_colors, n >= 0 ? n : 0);
  }
}, Ho = `/* eslint-disable no-undef */
/**
...
`, ui = "flowme-keyframes", vt = "flowme-cycle", Uo = 5, Wo = 2, te = null, hi = !1;
function jo() {
  if (document.getElementById(ui)) return;
  const i = document.createElement("style");
  i.id = ui, i.textContent = `@keyframes ${vt} { from { --flowme-progress: 0; } to { --flowme-progress: 1; } }`, document.head.appendChild(i);
}
function Vo() {
  if (hi) return;
...
async function Go() {
  ...
  if (!i)
    return te = Promise.reject(/* @__PURE__ */ new Error("paintWorklet not available")), te;
  const e = new Blob([Ho], { type: "application/javascript" }), t = URL.createObjectURL(e);
  return te = i.addModule(t).catch((n) => {
    throw te = null, n;
  }).finally(() => {
  }), te;
}
var qo = class {
  constructor() {
    this.container = null, this.config = null, this.resizeObserver = null, this.wrapper = null, this.flowDivs = /* @__PURE__ */ new Map(), this.flowsById = /* @__PURE__ */ new Map(), this.latestValues = /* @__PURE__ */ new Map(), this.applyUpdate = pn(() => this.flushUpdates(), 120), this.lastDurMsByFlow = /* @__PURE__ */ new Map(), this._currentDuration = /* @__PURE__ */ new Map();
  }
  async init(i, e) {
    this.container = i, A("Houdini init start dims:", i.offsetWidth, i.offsetHeight), this.config = e, this.flowsById = new Map(e.flows.map((o) => [o.id, o])), jo(), Vo(), await Go();
    ...
    const n = await an(i);
    (n.width === 0 || n.height === 0) && await ln(i), A("Houdini stable dims:", i.offsetWidth, i.offsetHeight), this.rebuildPaths(), A("Houdini post-resize dims:", i.offsetWidth, i.offsetHeight);
  }
  applyConfig(i) {
  ...
  rebuildPaths() {
    ...
    for (const t of this.config.flows) {
      ...
      const s = [
        ...
        ...t.waypoints,
        r.position
      ].map((a) => Se(a, i)).map((a) => `${a.x.toFixed(1)},${a.y.toFixed(1)}`).join(" ");
  ...
  applyFlow(i, e) {
    ...
    if (!t || !n) return;
    const o = Ce(e), r = this.profileFor(t), s = qe(t, r, this.config), a = dn(o, s, { flowId: i });
    if (t.visible === !1) {
    ...
    if (a)
      ...
      const M = Math.max(50, Rt(o, s) * d), R = cn(this._currentDuration.get(i) ?? M, M);
      this._currentDuration.set(i, R), l = R;
    }
    const p = t.animation?.direction ?? "auto";
    let u;
    p === "forward" ? u = 1 : p === "reverse" ? u = -1 : p === "both" ? u = 1 : u = o >= 0 ? 1 : -1;
    const h = t.domain ?? this.config?.domain, f = this.config?.flows.findIndex((M) => M.id === t.id) ?? -1, y = ae(t, r, h, u, this.config?.domain_colors, f >= 0 ? f : 0), m = a ? 0 : Math.max(1, Math.round(r.particle_count_curve ? r.particle_count_curve(o) : 3)), v = r.wave_amplitude_curve ? r.wave_amplitude_curve(o) : 4, g = n.el.style;
    g.setProperty("--flowme-shape", r.shape), g.setProperty("--flowme-color", y), g.setProperty("--flowme-glow", r.glow ? "1" : "0"), g.setProperty("--flowme-count", String(m)), g.setProperty("--flowme-radius", String(Uo)), g.setProperty("--flowme-line", String(Wo)), g.setProperty("--flowme-amp", String(v)), g.setProperty("--flowme-direction", String(u));
    ...
    this.lastDurMsByFlow.set(i, l), g.animation = a ? "none" : `${vt} calc(var(--flowme-dur) * 1ms) linear infinite`;
  }
  profileFor(i) {
    return O(i.domain ?? this.config?.domain);
  }
...
function Xo() {
  const i = Zo(), e = i ?? "svg", t = Yo(), n = hn();
  return A("renderer selected:", n || e !== "houdini" ? "SvgRenderer" : "HoudiniRenderer", "| override=", i ?? "(none)", "| Houdini available:", t, "| reduced motion:", n, "| paintWorklet in CSS?", typeof CSS < "u" && "paintWorklet" in CSS), n ? new Oe() : e === "houdini" ? t ? new qo() : (A("?flowme_renderer=houdini requested but unsupported — falling back to SVG"), new Oe()) : new Oe();
}
function Yo() {
  try {
    const i = CSS;
...
async function Qo() {
  ...
  return typeof i != "function" ? null : (de = i().then((e) => (nt = e, de = null, e)).catch((e) => {
    throw de = null, e;
  }), de);
}
async function er(i) {
...
var ot, Fe = (ot = class extends oe {
  constructor(...e) {
    super(...e), this._needsRebuildOnConnect = !1;
  }
  connectedCallback() {
    super.connectedCallback(), this._needsRebuildOnConnect && (this._needsRebuildOnConnect = !1, this.lastMountedConfigJson = void 0, this.rebuildChild());
  }
  updated(e) {
  ...
  disconnectedCallback() {
    this.disposeChild(), this._needsRebuildOnConnect = !0, super.disconnectedCallback();
  }
  ...
  rebuildChild() {
    ...
    if (t !== this.lastMountedConfigJson && (this.lastMountedConfigJson = t, this.disposeChild(), !!e)) {
      ...
      this.errorMessage = void 0, er(e).then((n) => {
        if (!n) {
  ...
  `, ot);
F([Pe({ attribute: !1 })], Fe.prototype, "hass", void 0);
F([Pe({ attribute: !1 })], Fe.prototype, "card", void 0);
F([P()], Fe.prototype, "errorMessage", void 0);
Fe = F([Mt("flowme-custom-overlay")], Fe);
var H = "http://www.w3.org/2000/svg";
function Ie(i, e) {
  if (!i || !e) return null;
  const t = i.states[e];
  return !t || t.state === "unavailable" || t.state === "unknown" ? null : we(t.state);
}
function tr(i, e) {
  ...
  for (const s of o) {
    const a = e.flows.findIndex((l) => l.id === s.id), d = ae(s, O(s.domain ?? t), s.domain ?? t, 1, e.domain_colors, a >= 0 ? a : 0);
    r.add(d);
  }
  return r.size === 1 ? [...r][0] : gn;
}
function ir(i) {
...
function be(i, e) {
  const { vbW: t, vbH: n } = Bt(e), o = t / e.widthPx, r = n / e.heightPx;
  return Math.min(i * o, i * r);
}
function fi(i, e) {
  const { vbW: t, vbH: n } = Bt(e);
...
var mn = class {
  ...
  sync(i, e, t, n, o) {
    ...
    const l = o?.getLayoutMetrics?.(i) ?? ir(i), p = e.defaults?.node_radius ?? 12;
    ...
    for (const u of e.nodes) {
      ...
      const f = u.size ?? p, y = be(f, l), { cx: m, cy: v } = gi(u.position, l), g = tr(u, e), w = document.createElementNS(H, "g");
  ...
  appendGlow(i, e, t, n, o, r, s, a, d) {
    ...
    const { cx: w, cy: x } = gi(e.position, d), M = document.createElementNS(H, "circle");
    M.setAttribute("cx", String(w)), M.setAttribute("cy", String(x)), M.setAttribute("r", String(be(s, d))), M.setAttribute("fill", "none"), M.setAttribute("stroke", f), M.setAttribute("stroke-width", String(fi(2, d))), M.setAttribute("opacity", String(g)), M.setAttribute("style", `filter: drop-shadow(0 0 ${v.toFixed(1)}px ${f}); transition: filter 500ms ease, opacity 500ms ease`), i.appendChild(M);
  }
  cancelRippleBurst(i, e) {
    ...
    if (e) {
      const n = `[data-ripple-owner="${nr(i)}"]`;
  ...
  spawnRippleRing(i, e, t, n, o, r, s, a) {
    const d = be(o + 2, a), l = be(o * 4, a), p = fi(2, a), u = document.createElementNS(H, "g");
  ...
  appendBadge(i, e, t, n, o, r, s, a, d, l, p) {
    ...
    const m = be(d * 0.6, l), v = s + Math.min(m * 1.1, 3), g = a - Math.min(m * 1.1, 3), w = document.createElementNS(H, "circle");
  ...
  push(i) {
    if (i.prev !== i.next) {
      for (this.apply(i.next), this.undoStack.push(i); this.undoStack.length > or; ) this.undoStack.shift();
...
function Ur(i, e, t) {
  return e < 0 || t < 0 || e >= i.cols || t >= i.rows ? yt : i.data[Hr(i, e, t)] ?? yt;
}
function Wr(i, e, t = 480, n = 270) {
  if (i <= 0 || e <= 0) return {
    width: 1,
    height: 1
  };
...
function bn(i, e, t) {
  const n = Wr(e, t), o = document.createElement("canvas");
...
function qr(i, e, t) {
  const { width: n, height: o, rgba: r } = bn(i, e, t);
  return Gr(Vr(jr(r, n, o), n, o), n, o);
}
var Xr = class {
  constructor() {
    this.arr = [];
...
function Yr(i, e, t) {
  ...
  for (; y.size > 0; ) {
    ...
    if (!h[w]) {
      if (h[w] = 1, v === r && g === s) return Zr(i, l, p, t);
      for (const [x, M, R] of m) {
        const k = v + x, S = g + M;
        if (k < 0 || S < 0 || k >= i.cols || S >= i.rows) continue;
        const T = S * i.cols + k;
        if (h[T]) continue;
        const I = Ur(i, k, S), z = u[w] && u[w] !== R ? 50 : 0, U = (d[w] ?? 1 / 0) + I + z;
        if (U < (d[T] ?? 1 / 0)) {
          d[T] = U, l[T] = v, p[T] = g, u[T] = R;
          const le = U + Ei(k, S, r, s);
          y.push({
            col: k,
            row: S,
            f: le
...
function Jr(i, e, t) {
  const n = Yr(i, Ti(e, i), Ti(t, i));
  return !n || n.length < 2 ? {
    waypoints: [],
    edgesUsable: !0
  } : {
    waypoints: Kr(n).slice(1, -1).map((o) => Qr(o, i)),
    edgesUsable: !0
  };
}
function Ti(i, e) {
  return [Ii(Math.floor(i.x / 100 * e.cols), 0, e.cols - 1), Ii(Math.floor(i.y / 100 * e.rows), 0, e.rows - 1)];
}
function Qr(i, e) {
  return {
...
var Dt = "Suggest Path is not available for video backgrounds. Set a static image as background to use this feature.", Le = /* @__PURE__ */ new Map();
async function Bi(i, e = {}) {
  if (W(i.imageUrl)) throw new Error(Dt);
  const t = performance.now(), n = e.cellSize ?? 8, o = `${i.imageUrl}|${n}`, r = Le.has(o);
  let s;
  try {
    s = await ts(o, i.imageUrl, n);
  } catch {
    s = null;
  }
  if (!s) return {
  ...
  const { waypoints: a, edgesUsable: d } = Jr(s, i.from, i.to);
  return {
    waypoints: a,
    cached: r,
    edgesUsable: d,
...
async function es(i) {
  if (W(i)) throw new Error(Dt);
  if (!i) return null;
  try {
    const e = await vn(i);
    return bn(e, e.naturalWidth, e.naturalHeight);
  } catch {
    return null;
  }
}
...
async function is(i, e) {
  ...
  const t = await vn(i);
  await Di();
  const n = qr(t, t.naturalWidth, t.naturalHeight);
  return await Di(), Lr(n, e);
}
function vn(i) {
...
var yn = "flowme", zi = "/local/flowme-backgrounds/";
function ns() {
  return `media-source://media_source/${yn}/.`;
}
function os(i) {
  const e = typeof i.media_content_id == "string" ? i.media_content_id : "", t = `media-source://media_source/${yn}/`;
  if (e.startsWith(t)) {
...
//# sourceMappingURL=pathfinding.worker-DNFn7c0I.js.map`, Oi = typeof self < "u" && self.Blob && new Blob(["URL.revokeObjectURL(import.meta.url);", wn], { type: "text/javascript;charset=utf-8" });
function rs(i) {
  let e;
  try {
    ...
    return new Worker("data:text/javascript;charset=utf-8," + encodeURIComponent(wn), {
      type: "module",
      name: i?.name
    });
  }
}
var ve, He, ct = "not_configured", ss = [
  ".jpg",
  ".jpeg",
  ".png",
  ".gif",
...
var E = (ve = class extends oe {
  constructor(...e) {
    super(...e), this.pending = null, this.previewMode = !1, this.selectedNodeId = null, this.selectedNodeIds = /* @__PURE__ */ new Set(), this.selectedFlowId = null, this.selectedOverlayId = null, this.customConfigDraft = "", this.customConfigError = "", this.errorMessage = "", this.inlineRename = null, this.canUndo = !1, this.nodeLabelInputRef = J(), this.flowIdInputRef = J(), this.overlayIdInputRef = J(), this._pendingInspectorLabelFocus = !1, this.canRedo = !1, this.undoLabel = "", this.redoLabel = "", this.suggestPreview = null, this.suggestBusy = !1, this.flowEndpointPathfindingFlowId = null, this.flowEndpointError = null, this.flowZeroThresholdDraft = {}, this.imageBrowserOpen = !1, this.imageBrowserLoading = !1, this.imageBrowserError = "", this.imageBrowserField = "default", this.imageBrowserFiles = [], this._pathWorkerPending = !1, this._pathPendingSelection = null, this.activeTab = "card", this.canvasCollapsed = !1, this.showAdvanced = {}, this.scale = 1, this.panX = 0, this.panY = 0, this.fitScale = 1, this.fitPanX = 0, this.fitPanY = 0, this.imageNaturalW = 0, this.imageNaturalH = 0, this.imageLayoutReady = !1, this._loadedImageUrl = "", this.spaceHeld = !1, this.panPointerId = null, this.stageRef = J(), this.canvasRef = J(), this.editorFxSvgRef = J(), this.editorNodeFx = new mn(), this._editorFxRaf = null, this.undoStack = new rr((t) => this.applyConfig(t, !1)), this.unsubscribe = null, this._ownCommit = !1, this.dragPointerId = null, this.dragTarget = null, this.dragStartConfig = null, this.dragShiftHeld = !1, this.dragStartPx = null, this.dragMoved = !1, this.onDefaultBgChange = (t) => {
      if (!this.config) return;
      const n = t.target.value, o = this.config, r = xi(o, n);
      this.pushPatch(o, r, "edit default background");
    }, this.onWeatherStateRemove = (t) => {
      if (!this.config) return;
      const n = this.config, o = wr(n, t);
      this.pushPatch(n, o, `remove weather state ${t}`);
    }, this.onWeatherStateAdd = () => {
      if (!this.config) return;
      const t = this.config, n = yr(t), o = t.background.weather_states ?? {}, r = Object.keys(n.background.weather_states ?? {}).find((s) => !(s in o));
      ...
      if (a)
        ...
        const { config: p, flow: u } = wi(s, t, n, r);
        l = u.id, d = {
          ...p,
      ...
      if (this.config && !t.target?.closest(".handle, .waypoint")) {
        if (this.pending?.kind === "add-node") {
          ...
          if (!n) return;
          const o = this.config, { config: r, node: s } = lr(o, n, c("editor.inspector.newNodeDefaultLabel"));
        ...
        if (this.pending?.kind === "add-overlay") {
          ...
          }, r = this.config, { config: s, overlay: a } = $r(r, o);
      ...
      if (t.shiftKey && Number.isFinite(s)) {
        ...
        if (!a) return;
        const d = this.config, l = vi(d, o, s, a);
      ...
      if (n && this.pending?.kind === "add-flow") {
        ...
        if (this.pending.step === "pick-to" && this.pending.fromId !== n) {
          const o = window.prompt(c("editor.inspector.flowEntityPrompt"), c("editor.inspector.flowEntityDefault")) ?? c("editor.inspector.flowEntityDefault"), r = this.config, { config: s, flow: a } = wi(r, this.pending.fromId, n, o);
      ...
      const s = this.config, a = yi(s, o, r);
      ...
      if (this.dragShiftHeld = t.shiftKey, n.kind === "overlay-resize") {
        ...
        this.dragShiftHeld && (h = Math.round(h), f = Math.round(f)), this.dragMoved = !0, this.config = _i(this.config, n.id, {
          width: h,
          height: f
        });
        return;
      ...
      if (n.kind === "node") this.config = rt(this.config, n.id, r);
        ...
        for (const [f, y] of n.startPositions) {
          const m = this.dragShiftHeld ? Be(y.x + p) : y.x + p, v = this.dragShiftHeld ? Be(y.y + u) : y.y + u;
          h.set(f, {
            x: m,
            y: v
          });
        }
        this.config = dr(this.config, h);
  ...
  willUpdate(e) {
    if (super.willUpdate(e), e.has("hass")) {
      ...
      t !== this._lastLanguage && (this._lastLanguage = t, nn(t));
    }
  }
  updated(e) {
  ...
  toggleAdvanced(e, t) {
    if (this.showAdvanced = {
      ...
      if (this.flowZeroThresholdDraft = s, o?.animation?.zero_threshold !== void 0) {
        const a = this.config, d = Z(a, n, { zero_threshold: void 0 });
  ...
  loadBackgroundImage(e) {
    if (!e) {
      const n = as(this.config?.aspect_ratio ?? "16:10");
  ...
  setConfig(e) {
    try {
      ne(rn(e)), this.config = xe(e), ne(this.config.debug ?? !1), this._ownCommit ? this._ownCommit = !1 : (this.savedConfig = this.config, this.undoStack.clear()), this.errorMessage = "";
      const t = this.config?.background?.default ?? "";
      this.loadBackgroundImage(t), this.updateComplete.then(() => this.recalcFit());
    } catch (t) {
      ne(!1), this.errorMessage = t instanceof Error ? t.message : String(t);
    }
  }
  render() {
  ...
  renderFlowConnector(e) {
    ...
    const r = [
      ...
      ...e.waypoints,
      o.position
    ], s = e.id === this.selectedFlowId, a = ye(r, {
  ...
  renderHandle(e) {
    ...
    return b`
      ...
      const p = this.config, u = Si(p, e.id, s);
  ...
  renderInspector() {
    ...
    if (this.selectedNodeId) {
      ...
      if (n && !t) {
        ...
        <div class="inspector">
          ...
          const d = this.config, l = Rr(d, n.id, a);
          ...
          const d = this.config, l = Er(d, n.id, a);
          this.pushPatch(d, l, `set show_value of ${n.id}`);
                ...
                <label class="node-cell node-cell-toggle">
                  <input
                    ...
                    @change=${(s) => {
          if (!this.config) return;
          const a = s.target.checked, d = this.config, l = Si(d, n.id, a);
          ...
          const d = this.config, l = rt(d, n.id, {
            x: a,
            y: n.position.y
          });
          ...
          const a = parseFloat(s.target.value);
          if (!Number.isFinite(a)) return;
          const d = this.config, l = Cr(d, n.id, a >= 1 ? void 0 : a);
    ...
    if (e) {
      const n = e, o = this.config.flows.findIndex((m) => m.id === n.id), r = B(n), s = this.showAdvanced.flows === !0, a = O(n.domain ?? this.config.domain), d = qe(n, a, this.config), l = a.peak, p = [
        0,
        d.peak * 0.5,
        d.peak
      ].map((m) => `${(Rt(m, d) / 1e3).toFixed(1)}s`), u = this.flowZeroThresholdDraft[n.id];
      let h;
      if (u !== void 0 && u.trim() !== "") {
      ...
      return b`
        ...
        this.onFlowRoleChange(n.id, v);
                  ...
                  >
                    ...
                    ${(j[n.domain ?? this.config.domain] ?? j.generic).roles.map((m) => b`<option value=${m.key}>${m.label} (${m.key})</option>`)}
                  </select>
                  <span
              ...
              <label>
                ...
                <div class="row">
                  <input
                    ...
                    @change=${(m) => {
        if (!this.config) return;
        const v = m.target.checked, g = this.config, w = Nr(g, n.id, v);
          ...
          ${this.renderSectionCard(c("editor.section.flowAnimation"), b`
              <label>
                ...
                <select
                  ...
                  @change=${(m) => {
        if (!this.config) return;
        const v = m.target.value, g = this.config, w = Pr(g, n.id, v);
        this.pushPatch(g, w, `set line style of ${r}`);
      }}
                >
                  ${ut.map((m) => b`<option value=${m} ?selected=${(n.line_style ?? "corner") === m}>${m}</option>`)}
                </select>
              </label>
        ...
        const v = m.target.value.trim(), g = this.config;
        if (v === "") {
          const M = Z(g, n.id, { min_duration: void 0 });
          this.pushPatch(g, M, `clear flow min_duration ${r}`);
          return;
        }
        const w = parseInt(v, 10);
        if (!Number.isFinite(w) || w <= 0) return;
        const x = Z(g, n.id, { min_duration: w });
        ...
        const v = m.target.value.trim(), g = this.config;
        if (v === "") {
          const M = Z(g, n.id, { max_duration: void 0 });
          this.pushPatch(g, M, `clear flow max_duration ${r}`);
          return;
        }
        const w = parseInt(v, 10);
        if (!Number.isFinite(w) || w <= 0) return;
        const x = Z(g, n.id, { max_duration: w });
        this.pushPatch(g, x, `set flow max_duration ${r}`);
                  ...
                  <label>
                    ...
                    <div class="color-row">
                      ${(() => {
        const m = ae(n, O(n.domain ?? this.config.domain), n.domain ?? this.config.domain, 1, this.config.domain_colors, o >= 0 ? o : 0);
        return b`
                          <input
                            type="color"
                            .value=${n.color ?? m}
                            @change=${(v) => {
          if (!this.config) return;
          const g = v.target.value, w = this.config, x = Ai(w, n.id, g);
          ...
          if (!this.config) return;
          const v = this.config, g = Ai(v, n.id, void 0);
        ...
        if (v === "") {
          w();
          const R = Z(g, n.id, { zero_threshold: void 0 });
        ...
        w();
        const M = Z(g, n.id, { zero_threshold: x / 100 });
        ...
        const g = this.config, w = Fr(g, n.id, v);
  ...
  renderAnimationSection(e) {
    ...
    const t = e.animation ?? {}, n = t.animation_style ?? "dots", o = (l) => {
      if (!this.config) return;
      const p = this.config, u = Z(p, e.id, l);
    ...
    return b`
      ...
      o({ animation_style: l.target.value });
            ...
            >
              ${ht.map((l) => b`<option value=${l} ?selected=${n === l}>${l}</option>`)}
            </select>
          </label>
      ...
      o({ particle_shape: l.target.value });
              ...
              >
                ${ft.map((l) => b`<option value=${l} ?selected=${(t.particle_shape ?? "circle") === l}>${l}</option>`)}
              </select>
            </label>
      ...
      o({ direction: l.target.value });
            ...
            >
              ${gt.map((l) => b`<option value=${l} ?selected=${(t.direction ?? "auto") === l}>${l}</option>`)}
            </select>
          </label>
      ...
      o({ particle_spacing: l.target.value });
            ...
            >
              ${mt.map((l) => b`<option value=${l} ?selected=${(t.particle_spacing ?? "even") === l}>${l}</option>`)}
            </select>
          </label>
      ...
      if (!this.config) return;
      const l = this.config, p = Ir(l, e.id);
  ...
  renderWaypointList(e) {
    ...
    const t = new Map(this.config.nodes.map((s) => [s.id, s])), n = t.get(e.from_node), o = t.get(e.to_node), r = () => {
      ...
      const l = s[a], p = s[a + 1], u = {
        x: (l.x + p.x) / 2,
        y: (l.y + p.y) / 2
      }, h = a > 0 ? a - 1 + 1 : 0, f = this.config, y = vi(f, e.id, h, u);
    ...
    return b`
      ...
      this.pushPatch(p, u, `move waypoint ${a} of ${B(e)}`);
                  ...
                  <button type="button" class="icon-btn" aria-label=${c("editor.inspector.deleteWaypointAria", a)} title=${c("editor.inspector.deleteWaypoint")}
                    @click=${() => {
      if (!this.config) return;
      const d = this.config, l = yi(d, e.id, a);
  ...
  renderValueGradientSection(e) {
    ...
    return b`
      <div class="gradient-section">
        ...
        <label class="anim-toggle">
          <input type="checkbox"
            ...
            @change=${(s) => {
      if (!this.config) return;
      const a = s.target.checked, d = this.config, l = a ? zr(d, e.id, n) : Ni(d, e.id);
      ...
      if (!this.config) return;
      const s = this.config, a = Ni(s, e.id);
    ...
    return b`
      <label>
        ...
        <div class="inspector-slider-row">
          <input type="range" min="10" max="60" step="5"
            ...
            @change=${(t) => {
      if (!this.config) return;
      const n = parseInt(t.target.value, 10), o = this.config, r = Mi(o, { fps: n });
      ...
      <label class="visibility-row">
        <input type="checkbox"
          ...
          @change=${(t) => {
      if (!this.config) return;
      const n = t.target.checked, o = this.config, r = Mi(o, { smooth_speed: n });
      ...
      <label class="visibility-row">
        <input
          ...
          @change=${(t) => {
      if (!this.config) return;
      const n = t.target.checked, o = this.config, r = Dr(o, n);
  ...
  renderOverlayInspector(e) {
    ...
    return b`
      ...
      const l = this.config, p = at(l, e.id, {
        x: d,
        y: s.y
      });
      ...
      this.pushPatch(l, p, `move overlay ${e.id} y`);
            ...
            <label class="toggle-label">
              ...
              <input
                ...
                @change=${(a) => {
      if (!this.config) return;
      const d = a.target.checked, l = this.config, p = Ar(l, e.id, d);
      ...
      const d = parseFloat(a.target.value);
      if (!Number.isFinite(d)) return;
      const l = this.config, p = Sr(l, e.id, d);
  ...
  renderOpacityPanelInner() {
    ...
    const e = this.config.opacity ?? {}, t = (n, o, r = 1) => {
      ...
      return b`
        ...
        const d = parseFloat(a.target.value);
        if (!Number.isFinite(d)) return;
        const l = this.config, p = ki(l, n, d);
  ...
  renderDomainColorsPanelInner() {
    if (!this.config) return _;
    const e = this.config.domain_colors ?? {}, t = this.config.domain ?? "energy", n = j[t] ?? j.generic, o = (r, s) => {
      ...
      return b`
          <div class="color-picker-row">
            ...
            <input
              ...
              @change=${(d) => {
        if (!this.config) return;
        const l = d.target.value, p = this.config, u = Ci(p, r.key, l);
        ...
        if (!this.config) return;
        const d = this.config, l = Ci(d, r.key, void 0);
  ...
  renderDefaultsPanel(e = "full") {
    if (!this.config) return _;
    const t = this.config.defaults ?? {}, n = en(this.config.domain), o = O(n), r = t.peak_value ?? o.peak, s = Math.round(r * 0.5886 * 10) / 10, a = (p, u, h) => {
      ...
      return b`
        ...
        const v = Math.max(h.min, Math.min(h.max, m)), g = this.config, w = lt(g, p, v);
    ...
    `, l = b`
      ...
      const h = this.config, f = lt(h, "peak_value", u);
      ...
      const u = parseFloat(p.target.value);
      if (!Number.isFinite(u) || u <= 0) return;
      const h = Math.round(u * 1.699 * 10) / 10, f = this.config, y = lt(f, "peak_value", h);
  ...
  renderBrowserPanel(e) {
    return b`
      <div class="image-browser">
        ${this.imageBrowserLoading ? b`<div class="browser-loading">${c("editor.stateA.loading")}</div>` : this.imageBrowserError === ct ? b`
  ...
  renderWeatherPanel() {
    ...
    return b`
      ...
      if (!this.config) return;
      const s = this.config, a = mr(s, r || void 0);
      ...
      const a = this.config, d = vr(a, s * 1e3);
      ...
      a.stopPropagation(), this.openImageBrowser("weather", r);
                  ...
                  <datalist id="flowme-weather-states">
                    ${He.KNOWN_WEATHER_STATES.map((r) => b`<option value=${r}></option>`)}
                  </datalist>
                ...
                <details class="hint-details">
                  ...
                  <div class="hint-states">
                    ${He.KNOWN_WEATHER_STATES.map((r) => b`<code>${r}</code>`)}
                    <p class="hint-sub">
  ...
  async openImageBrowser(e, t) {
    ...
    try {
      ...
      for (const s of o) {
        ...
        if (!ss.some((u) => d.endsWith(u))) continue;
        const l = os(a);
        if (!l) continue;
  ...
  selectBgImage(e) {
    ...
    const t = this.config;
    let n, o;
    this.imageBrowserField === "weather" && this.imageBrowserWeatherState ? (n = $i(t, this.imageBrowserWeatherState, e), o = "Set weather state image") : (n = xi(t, e), o = "Set background image"), this.pushPatch(t, n, o), this.imageBrowserOpen = !1, this.imageBrowserField = "default", this.imageBrowserWeatherState = void 0;
  }
  setWeatherEntityValue(e) {
    if (!this.config) return;
    const t = e.trim(), n = this.config, o = gr(n, t || void 0);
    this.pushPatch(n, o, "edit weather entity");
  }
  onTransparentModeChange(e) {
    if (!this.config) return;
    const t = this.deepCloneConfig(this.config), n = br(t, e);
  ...
  onWeatherStateKeyChange(e, t) {
    ...
    if (!n || n === e) return;
    const o = this.config, r = Mr(o, e, n);
    r !== o && this.pushPatch(o, r, `rename weather state ${e}→${n}`);
  }
  onWeatherStateUrlChange(e, t) {
    if (!this.config) return;
    const n = t.target.value, o = this.config, r = $i(o, e, n);
  ...
  async runSuggestPath() {
    ...
    if (W(r)) {
      this.errorMessage = c("editor.inspector.suggestAutoRouteFailed", "Suggest Path is not available for video backgrounds. Set a static image as background to use this feature."), this.suggestPreview = null;
      return;
    }
    if (typeof Worker > "u") {
  ...
  commitNodeInlineRename(e) {
    ...
    const s = this.config, a = bi(s, t.id, r);
  ...
  commitOverlayInlineRename(e) {
    ...
    const o = this.config, r = Fi(o, t.id, n);
    if (r === o) {
  ...
  onInspectorFlowIdChange(e, t) {
    if (!this.config) return;
    const n = t.target, o = n.value.trim(), r = this.config, s = Tr(r, e, o);
    if (s === r) {
  ...
  onInspectorOverlayIdChange(e, t) {
    if (!this.config) return;
    const n = t.target, o = n.value.trim(), r = this.config, s = Fi(r, e, o);
    if (s === r) {
      this.errorMessage = c("editor.errors.renameIdConflict"), n.value = e;
      return;
    }
  ...
  onNodeLabelChange(e, t) {
    if (!this.config) return;
    const n = t.target.value, o = this.config, r = o.nodes.find((d) => d.id === e)?.label ?? e, s = bi(o, e, n.trim() ? n.trim() : void 0), a = n.trim() ? n.trim() : void 0;
  ...
  resolveFlowInspectorColour(e) {
    ...
    return ae(e, n, t, 1, this.config.domain_colors, o >= 0 ? o : 0);
  }
  ...
  onFlowLabelChange(e, t) {
    ...
    if (!n) return;
    const o = t.trim(), r = this.config, s = Br(r, e, o === "" || o === n.id ? void 0 : o);
  ...
  pushPatch(e, t, n) {
    try {
      ...
      this.errorMessage = "", this.undoStack.push({
        ...
        next: r,
        description: n
      }), this.commitToHa(r), this.config = r, ne(r.debug ?? !1);
    } catch (o) {
  ...
  `, ve);
F([Pe({ attribute: !1 })], E.prototype, "hass", void 0);
...
E = He = F([Mt("flowme-card-editor")], E);
var dt, xn = "2.11.0";
console.info("%cFlowMe v" + xn + " loaded", "color: #FF6B00; font-weight: bold");
var Li = 5e3;
function ls(i) {
  if (!i) return "";
  const e = [], t = (n, o) => {
...
var V = (dt = class extends oe {
  constructor(...e) {
    ...
    }, this.toastVisible = !1, this.toastMessage = "", this.toastHideTimer = null, this.renderer = null, this.rendererMount = J(), this.nodeFxSvgRef = J(), this.nodeFx = new mn(), this._nodeFxRaf = null, this.bgLayerA = "", this.bgLayerB = "", this.activeLayer = "A", this.transitionTimer = null, this.preloadCache = /* @__PURE__ */ new Map(), this.lastAppliedBgUrl = "", this.warnedMissing = /* @__PURE__ */ new Set(), this._lastScaledValue = /* @__PURE__ */ new Map(), this.onOverlayKeydown = (t, n) => {
      (t.key === "Enter" || t.key === " ") && (t.preventDefault(), this.handleOverlayTap(n));
    }, this.backgroundVideoRef = (t) => {
      const n = t;
      n && n.play().catch(() => {
      });
    };
  ...
  set hass(e) {
    const t = this._hass;
    if (this._hass = e, e && e.language !== this._lastLanguage && (this._lastLanguage = e.language, nn(e.language)), e) {
      const n = this.config, o = [
  ...
  setConfig(e) {
    ne(rn(e)), A("setConfig start:", performance.now());
    try {
      const t = xe(e);
      ne(t.debug ?? !1), A("setConfig called:", JSON.parse(JSON.stringify(e ?? null))), A("setConfig validated → flows=", t.flows.length, "nodes=", t.nodes.length, "overlays=", t.overlays?.length ?? 0, "card", xn);
  ...
  beginRendererInitIfNeeded() {
    ...
    A("renderer init start:", performance.now()), this.teardownRenderer(), this.renderer = Xo(), this.rendererReadyFor = this.config;
    const t = this.config;
    this.renderer.init(e, t).then(() => {
      ...
      A("renderer init failed — falling back to SVG renderer", n), this.teardownRenderer(), this.renderer = new Oe(), this.rendererReadyFor = t, this.renderer.init(e, t).then(() => {
        A("renderer init complete:", performance.now()), this.hass ? this.pushAllValuesToRenderer() : this.syncRendererAriaLabels(), this.syncAnimationsToDocumentVisibility();
      }).catch((o) => {
  ...
  pushAllValuesToRenderer() {
    ...
    for (let t = 0; t < this.config.flows.length; t++) {
      const n = this.config.flows[t], o = this.hass.states[n.entity], r = we(o?.state), s = O(n.domain ?? this.config.domain), a = o?.attributes?.unit_of_measurement, d = ei(r, a, s.unit_scale);
      ...
      if ((l === void 0 || l !== d.value) && (this._lastScaledValue.set(n.id, d.value), this.renderer.updateFlow(n.id, d.value)), n.value_gradient && this.renderer.setGradientColor) {
        ...
        if (u && u.state !== "unavailable" && u.state !== "unknown") {
          ...
          if (Number.isFinite(h)) {
            const f = n.value_gradient, y = Math.max(f.low_value, Math.min(f.high_value, h)), m = un(h, f);
  ...
  describeFlowReading(e) {
    ...
    const o = we(t.state), r = t.attributes?.unit_of_measurement ?? "", s = ei(o, r, n.unit_scale);
  ...
  render() {
    ...
    const t = `${1 / (Qe(e.aspect_ratio) ?? 16 / 10) * 100}%`, n = e.background.transition_duration ?? Li, o = ls(e.opacity), r = e.background.transparent === !0;
    return b`
      <ha-card role="region" aria-label=${c("aria.card")}>
        <div
          class="stage"
        ...
        >
          ${this.renderBackgroundLayer(this.bgLayerA, this.activeLayer === "A", n, r)}
          ${this.renderBackgroundLayer(this.bgLayerB, this.activeLayer === "B", n, r)}
          <div class="renderer-mount" ${G(this.rendererMount)}></div>
          <svg
          ...
          <div class="overlay-host">
            ${(e.overlays ?? []).map((s) => (A("rendering overlay →", s.type, "position=", s.position, "size=", s.size), Jo(s, this.hass, { onOverlayKeydown: this.onOverlayKeydown })))}
          </div>
        </div>
        <div
  ...
  buildLayerStyle(e, t) {
    return `${e && !W(e) ? `background-image: url('${e}');` : ""} transition-duration: ${t}ms;`;
  }
  renderBackgroundLayer(e, t, n, o) {
    if (o) return b`<div class="background" style="opacity:0;pointer-events:none;"></div>`;
    const r = W(e), s = r || W(this.lastAppliedBgUrl) ? 0 : n;
    return b`
      <div
        class=${`background ${t ? "visible" : ""}`}
        style=${this.buildLayerStyle(e, s)}
      >
        ${r ? b`<video
  ...
  resolveTargetBackground() {
    ...
    if (e.weather_entity && e.weather_states && this.hass) {
      ...
      if (t) {
        const n = t.state, o = e.sun_entity ? this.hass.states[e.sun_entity]?.state : void 0, r = no(n, o, e.weather_states, e.default);
        let s = n;
  ...
  syncWeatherBackground() {
    ...
    const t = this.config.background.transition_duration ?? Li, n = W(e) || W(this.lastAppliedBgUrl);
    this.preload(e).then(() => {
      ...
      const o = this.activeLayer === "A" ? "B" : "A";
      if (o === "A" ? this.bgLayerA = e : this.bgLayerB = e, n) {
        requestAnimationFrame(() => {
          this.activeLayer = o, this.lastAppliedBgUrl = e, this.activeLayer === "A" ? this.bgLayerB = "" : this.bgLayerA = "";
        });
        return;
      }
      requestAnimationFrame(() => {
        this.activeLayer = o, this.lastAppliedBgUrl = e, this.transitionTimer = window.setTimeout(() => {
  ...
  preload(e) {
    if (!e || W(e)) return Promise.resolve();
  ...
  renderNodeHandle(e) {
    ...
    let d = "";
    if (t) {
      const p = we(t.state), u = t.attributes?.unit_of_measurement ?? "";
  ...
  nodeFlowColor(e) {
    ...
    for (let s = 0; s < this.config.flows.length; s++) {
      ...
      const d = ae(a, O(a.domain ?? t), a.domain ?? t, 1, n, s), l = d.toLowerCase();
      r.has(l) || (r.add(l), o || (o = d));
    }
    if (r.size !== 0)
      return r.size === 1 ? o : gn;
  }
  ...
  `, dt);
F([Pe({ attribute: !1 })], V.prototype, "hass", null);
F([P()], V.prototype, "config", void 0);
F([P()], V.prototype, "errorMessage", void 0);
F([P()], V.prototype, "toastVisible", void 0);
F([P()], V.prototype, "toastMessage", void 0);
F([P()], V.prototype, "bgLayerA", void 0);
F([P()], V.prototype, "bgLayerB", void 0);
F([P()], V.prototype, "activeLayer", void 0);
V = F([Mt("flowme-card")], V);
var wt = window;
